            ...
            <section>
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <li class="timeline-element">
                        ...
                        <p class="text-muted">
                                STTS pada mulanya dikenal dengan Institut Teknisi Elektro Surabaya (ITES) yang didirikan pada tanggal 1 Maret 1979.
                                 ...
                                 Penyelenggaraan perguruan tinggi ini didasarkan atas kesadaran untuk ikut berperan serta dalam memenuhi kebutuhan pendidikan tinggi khususnya di bidang teknik elektro.</p>
                    </li>
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="pcb.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="sekolahTinggi.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="teknikIndustri.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="swinburneUniversity.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="logoINF.png" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="logoSIB.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="desainIMG.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="gedungE.jpg" alt="..."></p>
                        <p class="text-muted">
                        ...
                        Gedung ini dipakai untuk layanan E-library, ruang pertemuan, ruang kuliah, ruang kuliah model theater dan ruang pertemuan bagi kegiatan kemahasiswaan.</p>
                    </li>
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="jurusan.jpg" alt="..."></p>
                        <p class="text-muted">
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="lingkunganSTTS.jpg" alt="..."></p>
                        <p class="text-muted">
                        <ul>
                    ...
                    <li class="timeline-element">
                        ...
                        <p><img class="img-fluid z-depth-1-half rounded" src="iSTTS.jpg" alt="..."></p>
                        <p class="text-muted">
